...
Public Class Menu
    ...
    Private Sub Button2_Click_1(sender As Object, e As EventArgs) Handles btnRegistrarVenta.Click
        ...
        Dim nombreRepuesto = If(cmbNombreRepuesto.SelectedItem?.ToString, "")
        ...
        Using connection As New MySqlConnection(connectionString)
            Try
                ...
                Dim Query = "SELECT CantidadStock, PrecioUnitario FROM Repuestos WHERE NombreRepuesto = @nombreRepuesto"
                Using cmd As New MySqlCommand(Query, connection)
                    cmd.Parameters.AddWithValue("@nombreRepuesto", nombreRepuesto)

                    Using reader = cmd.ExecuteReader
                        If reader.Read Then
                            Dim CantidadStock = Convert.ToInt32(reader("CantidadStock"))
                            Dim PrecioUnitario = Convert.ToDecimal(reader("PrecioUnitario"))
                            ...
                            If CantidadStock >= CantidadVendida Then
                                ...
                                Dim insertQuery = "INSERT INTO ventasrepuestos (NombreRepuesto, CantidadVendida, Cliente, FechaVenta, Total) VALUES (@nombreRepuesto, @cantidadVendida, @cliente, @fechaVenta, @total)"
                                ...
                                Dim updateStockQuery = "UPDATE repuestos SET CantidadStock = CantidadStock - @cantidadVendida WHERE NombreRepuesto = @nombreRepuesto"
                                ...
                                Dim resumenVenta = $"Resumen de Venta:{Environment.NewLine}" &
    ...
    Private Sub btnAplicarFiltros_Click(sender As Object, e As EventArgs) Handles btnAplicarFiltros.Click
        ...
        Dim cliente As String = If(cmbFiltroRepuesto.SelectedItem?.ToString(), "")
                ...
                Using cmd As New MySqlCommand(sql, conn)
                    Using reader As MySqlDataReader = cmd.ExecuteReader()
                        ...
                        While reader.Read()
                            ...
                            If Not cmbFiltroRepuesto.Items.Contains(cliente) Then
                                cmbFiltroRepuesto.Items.Add(cliente)
                            End If
                        End While
                    End Using
                End Using
    ...
    Private Sub btnRestaurarFiltros_Click(sender As Object, e As EventArgs) Handles btnAplicarFiltros.Click
        ...
        cmbFiltroRepuesto.SelectedIndex = -1 ' Desmarca el filtro de clientes
